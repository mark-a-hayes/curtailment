#####################
##
## Curtailment Analysis for Alder Flats 2010 point data
## With Weibull distribution analysis
##
## Mark A. Hayes
## Normandeau Associates, Inc.
##
## 12/12/2019 Start @ 12:04 pm, 
## STOPPED FOR LUNCH @ 12:27 pm for annual meeting
## Restart at 3:30 pm, finished at 3:45 pm. 
##
##
...
# Load 'survival' and 'MASS

install.packages("survival") # as needed
library(survival)

install.packages("MASS") # as needed
library(MASS)

## Load the historic wind dataframe

# using the 2008 csv. This is the full set of hourly data for the year 

data = read.table(file.choose(), header=TRUE, sep=",") # Modelled wind data for this year
...
windspeed_v82 <- c(0:30)
length(windspeed_v82)
power_v82 <- c(0,0,0,0,28,144,309,511,758,1017,1285,1504,1637,1637,1650,1650,1650,1650,1650,1650,1650,1650,1650,1650,1650,1650,1650,1650,1650,1650,1650)
length(power_v82)
...
# Is 52704 the same length as data vectors?

length(data$UV_080m) #52560 - yes

E_max <- (1.65*52704)/6 # 14,493 MWh per year
E_max  # 14,493 MWh per year

# Capacity factor for this location and turbine model:

E_total/E_max # 0.2329
...
Sys.Date()-3632 # 1/1/2010 on 11/11/2019. 
Sys.Date()-3268 # 12/31/2010/


# NOTE: Be sure to change Sys.Date() times and lat/lon coordinates. 
sun <- getSunlightTimes(date = seq.Date(Sys.Date()-3632, Sys.Date()-3268, by = 1), keep = c("sunrise", "sunset"), lat = 52.9315, lon = 245.05804, tz = "MST")
sun
summary(sun)
...
length(risky$UV_080m) # 6821 10-minute increments
6821/6 # 1136 hrs = Risky increments / 6 increments/hour

# Time (hrs) in full year
365*24*6
52560/6 # 8760 hours = hours for the full year 
52560/6/24 # Double checking calculation. For this year it is 366 days
...
non_risky <- E_total - E_risky
non_risky # 3055.6

# Power percentages

non_risky/E_total # 0.9052 Non-risky
E_risky/E_total # 0.0948 # in risky
...
a
length(risky$UV_080m) # 6821...Find the length of the windspeed vector in risky, as needed 
length(risky$UV_080m)/10 # 682...Find how many times a vector of length = 10 will fit in the risky windspeed vector
uniform_rep_mean <- rep(a, times = 682) # create a vector that repeats the a vector 702 times
uniform_rep_mean
6821-length(uniform_rep_mean)

# Create a second vector of 0's so 0's can be added to the a vector to make length equal to the risky vectors

a1 <- c(0) # Create a vector with the two zeros
...
length(risky$UV_080m) # 6821...Find the length of the windspeed vector in risky, as needed 
length(risky$UV_080m)/100 # 68.2...Find how many times a vector of length = 10 will fit in the risky windspeed vector
uniform_rep_min <- rep(uniform_rep_min, times = 68) # create a vector that repeats 68 times
6821-length(uniform_rep_min)
...
length(risky$UV_080m) # 6821...Find the length of the windspeed vector in risky, as needed 
length(risky$UV_080m)/10 # 682...Find how many times a vector of length = 10 will fit in the risky windspeed vector
uniform_rep_max <- rep(c, times = 682) # create a vector that repeats the a vector 702 times
6821-length(uniform_rep_max)

# Create a second vector of 0's so 0's can be added to the a vector to make length equal to the risky vectors

c1 <- c(0) # Create a vector with the two zeros
...
E_above_cutin # 320 E available in curtailment period # 402
E_total # Total Energy Available # 3375.6
E_total-E_above_cutin # Total E in non-risky period # 3055.6
...
E_above_5.0 # 306 MWh = E in curtailment period
cutin_to_5.0 <- subset(risky, risky$UV_080m<5.000)
total_E_5.0 <- E_above_5.0 + non_risky
total_E_5.0 # 3361.8 MWh
(total_E_5.0/E_total)*100 # 99.59
...
E_cutin_to_5.0_Uniform_mean+E_above_5.0 # 318.6 E generated during curtailment period
E_cutin_to_5.0_Uniform_mean+E_above_5.0+non_risky # annual production
((E_cutin_to_5.0_Uniform_mean+E_above_5.0+non_risky)/E_total)*100 # 99.96%
...
E_cutin_to_5.0_Uniform_min+E_above_5.0 # 319.9 E generated during curtailment period
E_cutin_to_5.0_Uniform_min+E_above_5.0+non_risky # annual production
((E_cutin_to_5.0_Uniform_min+E_above_5.0+non_risky)/E_total)*100 # 99.99%
...
E_cutin_to_5.0_Uniform_max+E_above_5.0 # 313.4 E generated during curtailment period
E_cutin_to_5.0_Uniform_max+E_above_5.0+non_risky # annual production
((E_cutin_to_5.0_Uniform_max+E_above_5.0+non_risky)/E_total)*100 # 99.80%
...
E_cutin_to_5.0_Random_mean+E_above_5.0 # 318.5 Power generated during curtailment period 
E_cutin_to_5.0_Random_mean+E_above_5.0+non_risky # annual production
((E_cutin_to_5.0_Random_mean+E_above_5.0+non_risky)/E_total)*100 # 99.95%
...
E_cutin_to_5.0_Random_min+E_above_5.0 # 320 Power generated during curtailment period 
E_cutin_to_5.0_Random_min+E_above_5.0+non_risky # annual production
((E_cutin_to_5.0_Random_min+E_above_5.0+non_risky)/E_total)*100 # 99.99%
...
E_cutin_to_5.0_Random_max+E_above_5.0 # 312.7 Power generated during curtailment period 
E_cutin_to_5.0_Random_max+E_above_5.0+non_risky # annual production
((E_cutin_to_5.0_Random_max+E_above_5.0+non_risky)/E_total)*100 # 99.78%
...
E_above_5.5 # 295 MWh = E in curtailment period
cutin_to_5.5 <- subset(risky, risky$UV_080m<5.500)
total_E_5.5 <- E_above_5.5 + non_risky
total_E_5.5 # 4780 MWh
(total_E_5.5/E_total)*100 # 99.27
...
E_cutin_to_5.5_Uniform_mean+E_above_5.5 # 317.5 E generated during curtailment period
E_cutin_to_5.5_Uniform_mean+E_above_5.5+non_risky # annual production
((E_cutin_to_5.5_Uniform_mean+E_above_5.5+non_risky)/E_total)*100 # 99.92%
...
E_cutin_to_5.5_Uniform_min+E_above_5.5 # 319.8 E generated during curtailment period
E_cutin_to_5.5_Uniform_min+E_above_5.5+non_risky # annual production
((E_cutin_to_5.5_Uniform_min+E_above_5.5+non_risky)/E_total)*100 # 99.99%
...
E_cutin_to_5.5_Uniform_max+E_above_5.5 # 307.7 E generated during curtailment period
E_cutin_to_5.5_Uniform_max+E_above_5.5+non_risky # annual production
((E_cutin_to_5.5_Uniform_max+E_above_5.5+non_risky)/E_total)*100 # 99.63%
...
E_cutin_to_5.5_Random_mean+E_above_5.5 # 317.4 Power generated during curtailment period 
E_cutin_to_5.5_Random_mean+E_above_5.5+non_risky # annual production
((E_cutin_to_5.5_Random_mean+E_above_5.5+non_risky)/E_total)*100 # 99.92%
...
E_cutin_to_5.5_Random_min+E_above_5.5 # 319.9 Power generated during curtailment period 
E_cutin_to_5.5_Random_min+E_above_5.5+non_risky # annual production
((E_cutin_to_5.5_Random_min+E_above_5.5+non_risky)/E_total)*100 # 99.99%
...
E_cutin_to_5.5_Random_max+E_above_5.5 # 307.4 Power generated during curtailment period 
E_cutin_to_5.5_Random_max+E_above_5.5+non_risky # annual production
((E_cutin_to_5.5_Random_max+E_above_5.5+non_risky)/E_total)*100 # 99.62%
...
E_above_6.0 # 273.5  MWh = E in curtailment period
cutin_to_6.0 <- subset(risky, risky$UV_080m<6.000)
total_E_6.0 <- E_above_6.0 + non_risky
total_E_6.0 # 4771 MWh
(total_E_6.0/E_total)*100 # 99.62
...
E_cutin_to_6.0_Uniform_mean+E_above_6.0 # 315.7 E generated during curtailment period
E_cutin_to_6.0_Uniform_mean+E_above_6.0+non_risky # annual production
((E_cutin_to_6.0_Uniform_mean+E_above_6.0+non_risky)/E_total)*100 # 99.87%
...
E_cutin_to_6.0_Uniform_min+E_above_6.0 # 319.6 E generated during curtailment period
E_cutin_to_6.0_Uniform_min+E_above_6.0+non_risky # annual production
((E_cutin_to_6.0_Uniform_min+E_above_6.0+non_risky)/E_total)*100 # 99.99%
...
E_cutin_to_6.0_Uniform_max+E_above_6.0 # 296.4 E generated during curtailment period
E_cutin_to_6.0_Uniform_max+E_above_6.0+non_risky # annual production
((E_cutin_to_6.0_Uniform_max+E_above_6.0+non_risky)/E_total)*100 # 99.30%
...
E_cutin_to_6.0_Random_mean+E_above_6.0 # 315.1 Power generated during curtailment period 
E_cutin_to_6.0_Random_mean+E_above_6.0+non_risky # annual production
((E_cutin_to_6.0_Random_mean+E_above_6.0+non_risky)/E_total)*100 # 99.85%
...
E_cutin_to_6.0_Random_min+E_above_6.0 # 319.5 Power generated during curtailment period 
E_cutin_to_6.0_Random_min+E_above_6.0+non_risky # annual production
((E_cutin_to_6.0_Random_min+E_above_6.0+non_risky)/E_total)*100 # 99.98%
...
E_cutin_to_6.0_Random_max+E_above_6.0 # 296.5 Power generated during curtailment period 
E_cutin_to_6.0_Random_max+E_above_6.0+non_risky # annual production
((E_cutin_to_6.0_Random_max+E_above_6.0+non_risky)/E_total)*100 # 99.30%
...
E_above_6.5 # 257.4 MWh = E in curtailment period
cutin_to_6.5 <- subset(risky, risky$UV_080m<6.500)
total_E_6.5 <- E_above_6.5 + non_risky
total_E_6.5 # 4763 MWh
(total_E_6.5/E_total)*100 # 98.14
...
E_cutin_to_6.5_Uniform_mean+E_above_6.5 # 313.7 E generated during curtailment period
E_cutin_to_6.5_Uniform_mean+E_above_6.5+non_risky # annual production
((E_cutin_to_6.5_Uniform_mean+E_above_6.5+non_risky)/E_total)*100 # 99.81%
...
E_cutin_to_6.5_Uniform_min+E_above_6.5 # 319.6 E generated during curtailment period
E_cutin_to_6.5_Uniform_min+E_above_6.5+non_risky # annual production
((E_cutin_to_6.5_Uniform_min+E_above_6.5+non_risky)/E_total)*100 # 99.98%
...
E_cutin_to_6.5_Uniform_max+E_above_6.5 # 289.0 E generated during curtailment period
E_cutin_to_6.5_Uniform_max+E_above_6.5+non_risky # annual production
((E_cutin_to_6.5_Uniform_max+E_above_6.5+non_risky)/E_total)*100 # 99.08%
...
E_cutin_to_6.5_Random_mean+E_above_6.5 # 313.0 Power generated during curtailment period 
E_cutin_to_6.5_Random_mean+E_above_6.5+non_risky # annual production
((E_cutin_to_6.5_Random_mean+E_above_6.5+non_risky)/E_total)*100 # 99.79%
...
E_cutin_to_6.5_Random_min+E_above_6.5 # 319.4 Power generated during curtailment period 
E_cutin_to_6.5_Random_min+E_above_6.5+non_risky # annual production
((E_cutin_to_6.5_Random_min+E_above_6.5+non_risky)/E_total)*100 # 99.98%
...
E_cutin_to_6.5_Random_max+E_above_6.5 # 288.2 Power generated during curtailment period 
E_cutin_to_6.5_Random_max+E_above_6.5+non_risky # annual production
((E_cutin_to_6.5_Random_max+E_above_6.5+non_risky)/E_total)*100 # 99.06%
...
E_above_7.0 # 230.8  MWh = E in curtailment period
cutin_to_7.0 <- subset(risky, risky$UV_080m<7.000)
total_E_7.0 <- E_above_7.0 + non_risky
total_E_7.0 # 4753 MWh
(total_E_7.0/E_total)*100 # 97.4
...
E_cutin_to_7.0_Uniform_mean+E_above_7.0 # 311.5 E generated during curtailment period
E_cutin_to_7.0_Uniform_mean+E_above_7.0+non_risky # annual production
((E_cutin_to_7.0_Uniform_mean+E_above_7.0+non_risky)/E_total)*100 # 99.75%
...
E_cutin_to_7.0_Uniform_min+E_above_7.0 # 319.3 E generated during curtailment period
E_cutin_to_7.0_Uniform_min+E_above_7.0+non_risky # annual production
((E_cutin_to_7.0_Uniform_min+E_above_7.0+non_risky)/E_total)*100 # 99.98%
...
E_cutin_to_7.0_Uniform_max+E_above_7.0 # 274.8 E generated during curtailment period
E_cutin_to_7.0_Uniform_max+E_above_7.0+non_risky # annual production
((E_cutin_to_7.0_Uniform_max+E_above_7.0+non_risky)/E_total)*100 # 98.66 %
...
E_cutin_to_7.0_Random_mean+E_above_7.0 # 310.2 Power generated during curtailment period 
E_cutin_to_7.0_Random_mean+E_above_7.0+non_risky # annual production
((E_cutin_to_7.0_Random_mean+E_above_7.0+non_risky)/E_total)*100 # 99.71%
...
E_cutin_to_7.0_Random_min+E_above_7.0 # 318.9 Power generated during curtailment period 
E_cutin_to_7.0_Random_min+E_above_7.0+non_risky # annual production
((E_cutin_to_7.0_Random_min+E_above_7.0+non_risky)/E_total)*100 # 99.97%
...
E_cutin_to_7.0_Random_max+E_above_7.0 # 274.5 Power generated during curtailment period 
E_cutin_to_7.0_Random_max+E_above_7.0+non_risky # annual production
((E_cutin_to_7.0_Random_max+E_above_7.0+non_risky)/E_total)*100 # 99.65 

# STOPPED HERE @ 3:44 pm 12/12/2019
